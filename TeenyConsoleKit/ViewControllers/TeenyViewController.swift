...
public class TeenyViewController: UIViewController {
	...
	open public override func motionBegan(_ motion: UIEvent.EventSubtype, with event: UIEvent?) {
...
extension TeenyViewController: PanDelegate {
	...
	public func console(_ console: TeenyConsoleViewController, pannedBy: CGPoint, velocity: CGPoint) {
