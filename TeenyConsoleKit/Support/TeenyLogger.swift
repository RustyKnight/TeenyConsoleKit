...
public class TeenyLogger {
	...
	public var consumer: LogConsumer?
	...
	public func log(verbose: String, date: Date = Date(), file: StaticString, function: StaticString, line: UInt) {
		log(type: self.verbose, message: verbose, date: date, file: file, function: function, line: line)
	}
	
	public func log(verbose: CustomStringConvertible, date: Date = Date(), file: StaticString, function: StaticString, line: UInt) {
		log(type: self.verbose, message: verbose.description, date: date, file: file, function: function, line: line)
	}
	
	public func log(info: String, date: Date = Date(), file: StaticString, function: StaticString, line: UInt) {
		log(type: self.info, message: info, date: date, file: file, function: function, line: line)
	}
	
	public func log(info: CustomStringConvertible, date: Date = Date(), file: StaticString, function: StaticString, line: UInt) {
		log(type: self.info, message: info.description, date: date, file: file, function: function, line: line)
	}
	
	public func log(warning: String, date: Date = Date(), file: StaticString, function: StaticString, line: UInt) {
		log(type: self.warning, message: warning, date: date, file: file, function: function, line: line)
	}
	
	public func log(warning: Error, date: Date = Date(), file: StaticString, function: StaticString, line: UInt) {
		log(type: self.warning, message: warning.localizedDescription, date: date, file: file, function: function, line: line)
	}
	
	public func log(warning: CustomStringConvertible, date: Date = Date(), file: StaticString, function: StaticString, line: UInt) {
		log(type: self.warning, message: warning.description, date: date, file: file, function: function, line: line)
	}
	
	public func log(error: String, date: Date = Date(), file: StaticString, function: StaticString, line: UInt) {
		log(type: self.error, message: error, date: date, file: file, function: function, line: line)
	}
	
	public func log(error: Error, date: Date = Date(), file: StaticString, function: StaticString, line: UInt) {
		log(type: self.error, message: error.localizedDescription, date: date, file: file, function: function, line: line)
	}
	
	public func log(error: CustomStringConvertible, date: Date = Date(), file: StaticString, function: StaticString, line: UInt) {
		log(type: self.error, message: error.description, date: date, file: file, function: function, line: line)
	}
	
	public func log(debug: String, date: Date = Date(), file: StaticString, function: StaticString, line: UInt) {
		log(type: self.debug, message: debug, date: date, file: file, function: function, line: line)
	}
	
	public func log(debug: CustomStringConvertible, date: Date = Date(), file: StaticString, function: StaticString, line: UInt) {
